...
export function NewMarketplaceItemPage() {
  ...
  const { 
    data: categoriesData 
  } = useApi<{ data: Array<{ id: string, name: string, slug: string }> }>('/marketplace/categories');

  // Fetch tags
  const { 
    data: tagsData 
  } = useApi<{ data: Array<{ id: string, name: string, slug: string }> }>('/marketplace/tags');
