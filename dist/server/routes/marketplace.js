...
router.get('/', async (req, res) => {
    try {
        const { limit = '10', page = '1', search, category, status, minPrice, maxPrice, sortBy = 'createdAt', order = 'desc' } = req.query;
...
router.post('/', async (req, res) => {
    try {
        const { title, description, price, imageUrl, categoryId, sellerId, specifications, features, stock, discountPrice, weight, dimensions, featured, tags = [], } = req.body;
...
router.put('/:id', async (req, res) => {
    try {
        const { id } = req.params;
        const { title, description, price, imageUrl, categoryId, specifications, features, stock, discountPrice, weight, dimensions, featured, tags = [], } = req.body;
